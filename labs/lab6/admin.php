<?php
    ...
    //Checks if the user logged in and the session is still active, otherwise reroutes to login page
    ...
    <head>
            ...
            <script>
                function confirmDelete(){
                    return confirm("Are you sure you want to delete the product?"); //Confirm() prompts the user with a text box
                }
